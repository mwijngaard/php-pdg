...
class Factory implements FactoryInterface {
	...
	/**
	 * Factory constructor.
	 * @param GraphFactoryInterface $graph_factory
	 * @param ControlDependenceGeneratorInterface $control_dependence_generator
	 * @param DataDependenceGeneratorInterface $data_dependence_generator
	 */
	...
	/**
	 * @param GraphFactoryInterface|null $graph_factory
	 * @return Factory
	 */
